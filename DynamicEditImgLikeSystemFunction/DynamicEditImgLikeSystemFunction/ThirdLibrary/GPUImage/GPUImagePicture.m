...
- (id)initWithCGImage:(CGImageRef)newImageSource smoothlyScaleOutput:(BOOL)smoothlyScaleOutput
{
    ...
    [self handleImg:newImageSource smoothlyScaleOutput:smoothlyScaleOutput];
    return self;
}
...
-(void)setImage:(UIImage *)image
{
    ...
    [self handleImg:_image.CGImage smoothlyScaleOutput:YES];
}

- (void)handleImg:(CGImageRef)newImageSource smoothlyScaleOutput:(BOOL)smoothlyScaleOutput
{
